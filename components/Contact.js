                            ...
                            <div className="padding-12 box-shadow">
                                ...
                                <form id="contactform" className="row contactform wrap-form clearfix" method="post" action="#" noValidate="novalidate">
                                    ...
                                    <label className="col-md-6">
                                        ...
                                        <span className="ttm-form-control"><input className="text-input" name="email" type="text" value="" placeholder="Your email-id:*" required="required"/></span>
                                    </label>
                                     <label className="col-md-6">
                                        <i className="ti ti-location-pin"></i>
                                        <span className="ttm-form-control"><input className="text-input" name="venue" type="text" value="" placeholder="Venue" required="required"/></span>
                                    </label>
                                    <label className="col-md-6">
                                        <i className="ti ti-mobile"></i>
                                        <span className="ttm-form-control"><input className="text-input" name="phone" type="text" value="" placeholder="Your Number:*" required="required"/></span>
                                    </label>
                                    <label className="col-md-12">
                                        <i className="ti ti-comment"></i>
                                        <span className="ttm-form-control"><textarea className="text-area" name="message" placeholder="Your Message:*" required="required"></textarea></span>
                                    </label>
                                    <input name="submit" type="submit" value="Make a Reservation" className="ttm-btn ttm-btn-size-md ttm-btn-shape-round ttm-btn-style-fill ttm-btn-color-skincolor mt-20" id="submit" title="Make a Reservation"/>
                               </form>
                            </div>
                        </Col>
                    </Row> 
